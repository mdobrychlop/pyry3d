...
##############################
   ...
   def t_error(self, t):
      raise FormatError("Illegal character %s" % repr(t))
      t.skip(1)
...
############Symmetry distances - added by jmk
   ...
   def p_symmetry_el_ch2(self, p):
      'symmetry_el : opt_restrid LPAREN resrange_list RPAREN chain DASH LPAREN resrange_list RPAREN chain LPAREN symmetry_no_dist RPAREN' #atom_and_weight RPAREN'
